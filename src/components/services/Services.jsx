...
function Services() {
    return (
        <div className='bg-black p-4 md:p-10'>
            <h1 className='text-center text-4xl md:text-6xl text-white mb-6 md:mb-10'>Services</h1>
            <div className='grid grid-cols-2 mx-auto md:grid-cols-3  sm:ms-24  md:ms-10 lg:grid-cols-4 lg:ms-10 xl:ms-16 gap-6'>
